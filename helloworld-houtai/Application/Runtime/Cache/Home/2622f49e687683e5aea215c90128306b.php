...
<head>
	...
	<link rel="stylesheet" href="css/myemojiPl.css"><!--表情-->
	<script src="js/jquery.js"></script>
	<script src="js/bootstrap.min.js"></script>
	<script src="js/myemojiPl.js"></script> 
	<script src="js/layer.js"></script>
	<script src="js/opwri.js"></script>
	...
	<div class="content">
		...
		<nav class="navbar navbar-default" role="navigation">
			<ul class="nav navbar-nav">
				...
				<li class="active"><a href="wdsc.html">我的收藏</a></li>
		...
		<div class="right">
			...
			<div class="admin bor">
				<a href="admin.html"><img src="img/index-user.png" style="margin:15px 0 0 42px;width:90;height:87;"></a>
		...
		<div class="left">
		    ...
		    <div class="tiezi">
		    		<div class="page">
		    			<div class="cont">
		    				<a href=""><img src="img/user-lit.png" style="margin:10px 0 0 10px;"></a>
