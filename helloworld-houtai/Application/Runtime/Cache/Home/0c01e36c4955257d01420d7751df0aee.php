...
<!-- <?php if(is_array($user)): $i = 0; $__LIST__ = $user;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$u): $mod = ($i % 2 );++$i;?><div class="content" style="margin-top:-49px;">
			...
			<div class="1fs">
				<div class="fs">
					...
					<button type="button" class="btn btn-sm fsgz" >
		    			<span class="glyphicon glyphicon-ok ">已关注</span>
		    		</button>
		    		<br/>
		    		<br/>
				</div>
