		    ...
		    <div class="httz">
		    		<div class="page">
		    			<div class="cont">
		    				...
		    				<button type="button" class="btn btn-sm" style="float:right; margin:-45px 10px 0 0;">
		    					<span class="glyphicon glyphicon-plus"> 关注</span>
		    				</button>
		    				<p style="margin:10px 10px 0 50px; font-size:15px;">[#软件男篮荣获冠军] 如果你无法简洁的表达你的想法，那只说明你还不够了解它。-- 阿尔伯特·爱因斯坦如果你无法简洁的表达你的想法，那只说明你还不够了解它。-- 阿尔伯特·爱因斯坦如果你无法简洁的表达你的想法，那只说明你还不够了解它。-- 阿尔伯特·爱因斯坦如果你无法简洁的表达你的想法，那只说明你还不够了解它。-- 阿尔伯特·爱因斯坦</p>
		    			</div>
