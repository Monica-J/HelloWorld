...
<head>
	...
	<link rel="stylesheet" href="../css/jsjl.css">
...
<body>
	<div class="header" style="border-radius:0px;">
		...
		<div class="logo">
			<a href="../index.html"><img src="../img/logo.png" style="margin:3px 0 0 30px;"></a>
		</div>
	...
	<div class="content">
		...
		<nav class="navbar navbar-default" role="navigation" style="margin-top:-49px;">
			<ul class="nav navbar-nav">
				...
				<li class="../active"><a href="ggtz.html">公告通知</a></li>
		...
		<div class="right">
			...
			<div class="admin" style="margin-top:-46px;">
				<a href="../admin.html"><img src="../img/index-user.png" style="margin:15px 0 0 46px;width:90;height:87;"></a>
				<p class="name">你的梦里有我吗</p>
				<p class="title"><img src="../img/title.png">工程师</p>
				...
				<div id="myCarousel" class="carousel slide">
					...
					<div class="carousel-inner" style="border-top:1px solid #dcdcdc;">
						<div class="item active">
							<img src="../img/HTML5.jpg" alt="First slide">
						</div>
						<div class="item">
							<img src="../img/HTML5.jpg" alt="Second slide">
						</div>
						<div class="item">
							<img src="../img/HTML5.jpg" alt="Third slide">
						</div>
						<br/>
					</div>
				</div>  
		...
		<div class="left">			
		    ...
		    <div class="q">
		    	<div class="wenti">
		    		<br/>
			    	<div class="box"> 
						<h3>谷歌大牛说：为什么 Kotlin 比你们用的那些垃圾语言都好</h3> 
						<p>&nbsp;&nbsp;5月18日，安卓团队在谷歌 I/O 2017 大会上宣布 Kotlin成为官方头等支持语言。这条爆炸性资讯在当天就是 Hacker News 首页热门讨论，与此同时，谷歌技术大牛 Steve Yegge 也写了一篇关于 Kotlin 的使用体会总结文章，同样也在首页热门，并引发 200+ 讨论。大家对此都有什么看法？
						</p> 
					</div>
					<div class="gn">
			    		<button type="button" class="btn" style="margin:-2px 0px 0 500px;">
							<span class="glyphicon glyphicon-plus">222关注</span>
						</button>
						<button type="button" class="btn btn-pl" style="margin:-2px 20px 0 0; float:right;">
							<span class="glyphicon glyphicon-pencil btn-click">1评论</span>
						</button>
			    	</div>
				</div>
				<br/> 
